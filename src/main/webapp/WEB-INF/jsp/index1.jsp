        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="customerDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Customer</a>
                    <div class="dropdown-menu" aria-labelledby="customerDropdown">
                        
                        <a class="dropdown-item" href="/customerReport">Customer Reports</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="variantDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Variant</a>
                    <div class="dropdown-menu" aria-labelledby="variantDropdown">
                        <a class="dropdown-item" href="/variantAdd">Variant Addition</a>
                        <a class="dropdown-item" href="/">Variant Deletion</a>
                        <a class="dropdown-item" href="/variantReport">Variant Reports</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="carDropdown">
                        <a class="dropdown-item" href="/carAdd">Car Addition</a>
                        <a class="dropdown-item" href="/carReport">Car Report</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
